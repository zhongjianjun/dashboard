...
const Commodity = () => LazilyLoadComponent(require.ensure([], require => require('./Containers/Commodity/index.jsx').default, 'route-Commodity'))//商品管理
const CommodityAddEdit = () => LazilyLoadComponent(require.ensure([], require => require('./Containers/Commodity/indexAddEdit.jsx').default, 'route-CommodityAddEdit'))//商品管理新增/编辑
      ...
      <ConnectedRouter history={history}>
        <Switch>
          ...
          <Layout>
            ...
            <Route path="/commodity/add" component={CommodityAddEdit}/>
            <Route path="/commodity/edit" component={CommodityAddEdit}/>
          </Layout>
