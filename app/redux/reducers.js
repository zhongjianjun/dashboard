...
import commodity from '../Containers/Commodity/reduce'

export default { app, layout, login, navigation, ad, adPlacement, link, live, weChat, channel, label, information, log, question, packages, commodity }
